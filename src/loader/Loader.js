...
Phaser.Loader.prototype = {
    ...
    */
    setPreloadFunction: function (foo) {
        this.foo = foo;
    },
    /*************************************************************************************************************/
    ...
    * @param {number} [direction=0] - A value of zero means the sprite width will be cropped, a value of 1 means its height will be cropped.
    */
    setPreloadSprite: function (sprite, direction, flag) {
        ...
        /****************************************************************************/
        if (flag) {
            this.preloadSprite.crop = new Phaser.Circle(sprite.width / 2, sprite.height / 2, 1);
        }
        /****************************************************************************/
        if (direction === 0)
        {
